// app/web-development-company-in-saudi-arabia/page.tsx
...
export const metadata: Metadata = {
  title: "Web Development Company in Saudi Arabia | Brighten Solutions",
  description:
    "Brighten Solutions provides professional web development, app development, SEO, and digital marketing services in Saudi Arabia.",
};
      ...
      <div className="pt-24">
        <div className="container mx-auto px-4 mb-16">
          <SectionTitle
            ...
            subtitle="Brighten Solutions delivers high-quality website development, app development, SEO, and digital marketing services for businesses in Saudi Arabia."
