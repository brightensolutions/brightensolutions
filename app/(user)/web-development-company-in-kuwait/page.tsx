// app/web-development-company-in-kuwait/page.tsx
...
export const metadata: Metadata = {
  title: "Web Development Company in Kuwait | Brighten Solutions",
  description:
    "Brighten Solutions provides professional web development, app development, SEO, and digital marketing services in Kuwait.",
};
      ...
      <div className="pt-24">
        <div className="container mx-auto px-4 mb-16">
          <SectionTitle
            ...
            highlight="Kuwait"
            subtitle="Brighten Solutions delivers high-quality website development, app development, SEO, and digital marketing services for businesses in Kuwait."
