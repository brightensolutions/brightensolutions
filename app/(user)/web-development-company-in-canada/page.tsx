// app/web-development-company-in-canada/page.tsx
...
export const metadata: Metadata = {
  title: "Web Development Company in Canada | Brighten Solutions",
  description:
    "Brighten Solutions provides professional web development, app development, SEO, and digital marketing services in Canada.",
};
      ...
      <div className="pt-24">
        <div className="container mx-auto px-4 mb-16">
          <SectionTitle
            ...
            highlight="Canada"
            subtitle="Brighten Solutions delivers high-quality website development, app development, SEO, and digital marketing services for businesses in Canada."
