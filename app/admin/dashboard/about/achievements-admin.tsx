...
export default function AchievementsAdmin() {
    ...
    try {
      ...
      if (currentAchievement) {
        ...
        const response = await fetch(
          `/api/about/achievements/${currentAchievement._id}`,
          {
            method: "PUT",
            headers: {
  ...
  if (loading && achievements.length === 0) {
    return (
      <div className="flex justify-center p-8">Loading achievements...</div>
    );
  }
    ...
    <div>
          ...
          <TableBody>
            {achievements.length === 0 ? (
              <TableRow>
                ...
                >
                  No achievements found. Add your first achievement to get
                  started.
                </TableCell>
              </TableRow>
            ) : (
                  ...
                  <TableCell>
                    <div className="relative h-10 w-10 rounded-md overflow-hidden">
                      <Image
                        src={
                          achievement.image ||
                          "/placeholder.svg?height=40&width=40&query=award"
                        }
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            <DialogTitle>
              {currentAchievement ? "Edit Achievement" : "Add Achievement"}
            </DialogTitle>
            <DialogDescription>
              {currentAchievement
                ...
                <div className="mt-2 flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-500">
                      Upload an image of the award or certificate. Maximum size:
                      2MB.
                    </p>
                  </div>
                </div>
      ...
      <Dialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Are you sure you want to delete "{currentAchievement?.title}"?
